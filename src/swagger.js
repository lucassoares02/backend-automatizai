...
const COMPANY_PROPS = {
  ...
  accepts_orders_outside_delivery_area: T.bool,
...
const COMPANY_EXAMPLE = {
  ...
  accepts_orders_outside_delivery_area: false,
    ...
    requestBody: body(
      {
        ...
        delivery_fee_pending_agreement: T.bool,
        items: T.arr(T.obj({ menu_item_id: T.int, promotion_id: T.int, quantity: T.int })),
      },
      { company_id: 12, client_id: 34, delivery_type: "delivery", delivery_address: "Rua A, 100", delivery_fee: 0, delivery_fee_pending_agreement: true, payment_method_id: 2, payment_provider: null, items: [{ menu_item_id: 55, quantity: 2 }] },
      ["company_id", "items"],
    ),
  },
